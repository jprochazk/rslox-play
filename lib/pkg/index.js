...
async function init(input) {
    ...
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_now_e88abe15a163012d = typeof window.Date.now == 'function' ? window.Date.now : notDefined('window.Date.now');
    imports.wbg.__wbg_log_91c5b2781749f02f = function(arg0, arg1) {
